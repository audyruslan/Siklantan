...
export default function Modalakun(props) {
    ...
    const [namaLengkap, setNamaLengkap] = useState(tampilModal?.nama);
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="flex-col bg-white shadow-xl rounded-2xl sm:mx-0 -mx-9 absolute items-end justify-end z-20 lg:w-2/5 w-full">
